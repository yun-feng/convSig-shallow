...
#print test_error;
np.savetxt("/data/ted/COAD/eso/exp/Feature_tran.txt",Feature, fmt='%s',delimiter='\t')
np.savetxt("/data/ted/COAD/eso/exp/Matrix_tran.txt",Matrix, fmt='%s',delimiter='\t')
np.savetxt("/data/ted/COAD/eso/exp/p_tran.txt",P, fmt='%.18e',delimiter='\t')
...
np.savetxt("/data/ted/COAD/eso/exp/conv_tran.txt",conv_all, fmt='%.18e',delimiter='\t')
