...
for iter in range(20):
	...
	print test_error;
	np.savetxt("/data/ted/COAD/eso/exp/Feature"+str(iter)+".txt",Feature, fmt='%s',delimiter='\t')
	np.savetxt("/data/ted/COAD/eso/exp/Matrix"+str(iter)+".txt",Matrix, fmt='%s',delimiter='\t')
	np.savetxt("/data/ted/COAD/eso/exp/p"+str(iter)+".txt",P, fmt='%.18e',delimiter='\t')
	...
	np.savetxt("/data/ted/COAD/eso/exp/conv"+str(iter)+".txt",conv_all, fmt='%.18e',delimiter='\t')
