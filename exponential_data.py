...
X=np.loadtxt("/data/ted/COAD/eso_5.mut.txt")
S=X.shape[0];#number of samples, from input
X=X.reshape((S,N,3))


Genome_BG=np.loadtxt("/data/ted/COAD/eso_5.wt.txt")
...
print test_error;
np.savetxt("/data/ted/COAD/eso_Feature_5.txt",Feature, fmt='%s',delimiter='\t')
np.savetxt("/data/ted/COAD/eso_Matrix_5.txt",Matrix, fmt='%s',delimiter='\t')
np.savetxt("/data/ted/COAD/eso_p_5.txt",P, fmt='%.18e',delimiter='\t')
...
np.savetxt("/data/ted/COAD/eso_conv_5.txt",conv_all, fmt='%.18e',delimiter='\t')
