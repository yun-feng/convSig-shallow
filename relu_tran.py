...
np.savetxt("/data/ted/COAD/eso/ReLU/Feature_tran.txt",Feature, fmt='%s',delimiter='\t')
np.savetxt("/data/ted/COAD/eso/ReLU/Matrix_tran.txt",Matrix, fmt='%s',delimiter='\t')
np.savetxt("/data/ted/COAD/eso/ReLU/P_tran.txt",P, fmt='%.18e',delimiter='\t')
...
np.savetxt("/data/ted/COAD/eso/ReLU/conv_tran.txt",conv_all, fmt='%.18e',delimiter='\t')
